...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'COREPYTHONPATH': ':',
 'COVERAGE_INFO': '/home/lipf/ssss/Python-3.6.3/coverage.info',
 'COVERAGE_REPORT': '/home/lipf/ssss/Python-3.6.3/lcov-report',
 ...
 'LN': 'ln',
 'LOCALMODLIBS': '-L/usr/local/lib -lz',
 ...
 'MODNAMES': '_thread posix errno pwd _sre _codecs _weakref _functools '
             ...
             '_locale _io zipimport faulthandler _tracemalloc _symtable array '
             'cmath math _struct select _socket _posixsubprocess zlib '
             'xxsubtype',
 'MODOBJS': 'Modules/_threadmodule.o  Modules/posixmodule.o  '
            ...
            'Modules/_math.o  Modules/_struct.o  Modules/selectmodule.o  '
            'Modules/socketmodule.o  Modules/_posixsubprocess.o  '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   '-Wall -Wstrict-prototypes -fPIC -std=c99 -Wextra '
